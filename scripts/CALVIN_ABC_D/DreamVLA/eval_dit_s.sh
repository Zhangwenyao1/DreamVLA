...
# 从 e15 到 e19 循环
for epoch in {10..15}; do
    # 1. 把 resume_from_checkpoint 动态改成 e${epoch}.pth
    resume_from_checkpoint="/inspire/hdd/project/robotsimulation/guchun-240107140023/Wenyao/DreamVLA/checkpoints/finetune_dreamvla_64_24layers_16heads_hd1024_calvin_abc_d_flow_as_mask_depth/${epoch}.pth"
