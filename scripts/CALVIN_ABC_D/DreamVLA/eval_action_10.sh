...
# 从 e15 到 e19 循环
for epoch in {5..15}; do
    # 1. 把 resume_from_checkpoint 动态改成 e${epoch}.pth
    resume_from_checkpoint="/inspire/hdd/project/robotsimulation/guchun-240107140023/Wenyao/DreamVLA/checkpoints/scratch_dreamvla_64_24layers_16heads_hd1024_calvin_abc_d_dit_b_with_flow_depth_action_10/${epoch}.pth"
    ...
    torchrun --nnodes=${node} --nproc_per_node=${node_num} --master_port=10256 eval_calvin.py \
        --traj_cons \
        --rgb_pad 10 \
        --gripper_pad 4 \
