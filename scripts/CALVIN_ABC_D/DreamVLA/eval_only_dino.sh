...
for epoch in {9..15}; do
    ...
    resume_from_checkpoint="/inspire/hdd/project/robotsimulation/guchun-240107140023/Wenyao/DreamVLA/checkpoints/finetune_dreamvla_64_24layers_16heads_hd1024_calvin_abc_d_dit_b_only_dino/${epoch}.pth"
