...
node=1
node_num=8
torchrun --nnodes=${node} --nproc_per_node=${node_num} --master_port=10219 train.py \
    --traj_cons \
    --rgb_pad 10 \
    --gripper_pad 4 \
    ...
    --run_name finetune_dreamvla_calvin_abc_d_dit_b_with_flow_depth_action_1 \
    --save_checkpoint \
    ...
    --load_track_labels \
    --track_label_path "/inspire/ssd/project/robotsimulation/guchun-240107140023/Wenyao/calvin_dense_k10_action_1/task_ABC_D" \
